...
<div class="container text-center" style="border: 1px solid #a1a1a1;padding: 15px;width: 18%;">
	...
	<img src="data:image/png;base64,{{DNS1D::getBarcodePNG('4445645656', 'UPCA')}}" alt="barcode" />
	<br>  4445645656
